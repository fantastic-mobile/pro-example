...
import{C as e,Ct as t,H as n,Tt as r,mt as i,rt as a,v as o,w as s,x as c,y as l}from"./vue.runtime.esm-bundler-DOMO_wpA.js";import{T as u,w as d,x as f}from"./src-C_SUC8up.js";import{t as p}from"./AppPageLayout-CilNLEuS.js";var m=s({__name:`_demo1`,setup(e){let r=i(0);return setInterval(()=>{r.value+=Math.floor(Math.random()*1e3)*(Math.random()>.5?1:-1)},2e3),(e,i)=>{let a=d;return n(),l(a,{value:t(r),"will-change":``,class:`text-4xl font-bold`},null,8,[`value`])}}}),h=`<script setup lang="ts">
const value = ref(0)
...
`,g=s({__name:`_demo2`,setup(e){let r=i(0);return setInterval(()=>{r.value+=Math.floor(Math.random()*1e3)*(Math.random()>.5?1:-1)},2e3),(e,i)=>{let a=d;return n(),l(a,{value:t(r),prefix:`￥`,suffix:`元`,"will-change":``,class:`text-4xl font-bold`},null,8,[`value`])}}}),_=`<script setup lang="ts">
const value = ref(0)
...
`,v={class:`flex flex-col gap-2`},y=s({__name:`_demo3`,setup(r){let a=i(0);return setInterval(()=>{a.value+=Math.floor(Math.random()*1e3)*(Math.random()>.5?1:-1)},2e3),(r,i)=>{let o=d;return n(),c(`div`,v,[e(o,{value:t(a),trend:1,"will-change":``,class:`text-4xl font-bold`},null,8,[`value`]),e(o,{value:t(a),trend:0,"will-change":``,class:`text-4xl font-bold`},null,8,[`value`]),e(o,{value:t(a),trend:-1,"will-change":``,class:`text-4xl font-bold`},null,8,[`value`])])}}}),b=`<script setup lang="ts">
const value = ref(0)
...
`,C=s({__name:`_demo5`,setup(e){let r=i(0);return setInterval(()=>{r.value+=Math.floor(Math.random()*1e3)*(Math.random()>.5?1:-1)},2e3),(e,i)=>{let a=d;return n(),l(a,{value:t(r),"transform-timing":{duration:750,easing:`ease-out`},"spin-timing":{duration:750,easing:`cubic-bezier(0.175, 0.885, 0.32, 1.275)`},"opacity-timing":{duration:350,easing:`ease-out`},"will-change":``,class:`text-4xl font-bold`},null,8,[`value`])}}}),w=`<script setup lang="ts">
const value = ref(0)
...
`,T={class:`flex-center-start gap-2`},E=s({__name:`_demo6`,setup(o){let s=i(0),l=i(0);return setInterval(()=>{s.value+=Math.floor(Math.random()*1e3)*(Math.random()>.5?1:-1),l.value+=Math.random()*(Math.random()>.5?1:-1)},2e3),(i,o)=>{let f=d,p=u;return n(),c(`div`,T,[e(p,null,{default:a(()=>[e(f,{value:t(s),locales:`zh-CN`,format:{style:`currency`,currency:`CNY`},"will-change":``,class:`text-4xl font-bold`},null,8,[`value`]),e(f,{value:t(l),locales:`zh-CN`,format:{style:`percent`,maximumFractionDigits:2,signDisplay:`always`},"will-change":``,class:r([`text-2xl text-green-500 font-bold`,{"text-red-500":t(l)<0}])},null,8,[`value`,`class`])]),_:1})])}}}),D=`<script setup lang="ts">
const value1 = ref(0)
const value2 = ref(0)
