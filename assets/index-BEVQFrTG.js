...
`,kt=D({__name:"index",setup(t){return(e,o)=>{const l=T,a=H;return k(),at(a,{navbar:"","navbar-start-side":"back"},{default:P(()=>[f(l,{code:i(dt)},{default:P(()=>[f(ft)]),_:1},8,["code"])]),_:1})}}});export{kt as default};
