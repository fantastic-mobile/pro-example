...
import{_ as x}from"./index-d6ZB0Jya.js";import{_ as $}from"./index.vue_vue_type_script_setup_true_lang-DMxm4nWt.js";import{d as m,z as F,k as o,o as s,q as h,u as r,p,a as u,b as n,t as _,f as y,s as i,c as g,w as l}from"./index-BLP5v8hh.js";import"./index.vue_vue_type_script_setup_true_lang-Bk9FuQCK.js";const w={key:0,class:"prefix"},T={class:"text"},k={key:1,class:"suffix"},d=m({name:"FmTrend",__name:"index",props:{value:{},type:{default:"up"},prefix:{default:""},suffix:{default:""},reverse:{type:Boolean,default:!1}},setup(c){const a=c,t=F(()=>{let e=a.type==="up";return a.reverse&&(e=!e),e});return(e,f)=>{const v=y;return s(),o("div",{class:h(["flex items-center transition",`${r(t)?"c-green":"c-red"}`])},[e.prefix?(s(),o("span",w,_(e.prefix),1)):p("",!0),u("span",T,_(e.value),1),e.suffix?(s(),o("span",k,_(e.suffix),1)):p("",!0),n(v,{name:"i-ep:caret-top",rotate:r(t)?0:180,class:"ml-1 transition"},null,8,["rotate"])],2)}}}),D={},B={class:"flex flex-col gap-2"};function C(c,a){const t=d;return s(),o("div",B,[n(t,{value:"12.3"}),n(t,{value:"12.3",type:"down"})])}const b=i(D,[["render",C]]),N=`<template>
