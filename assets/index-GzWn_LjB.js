...
`,pe=y({__name:"index",setup(m){return(u,n)=>{const c=I,a=V;return h(),Q(a,{navbar:"","navbar-start-side":"back"},{default:w(()=>[S("div",null,[d(c,{code:v(te)},{default:w(()=>[d(ee)]),_:1},8,["code"]),d(c,{code:v(le)},{default:w(()=>[d(oe)]),_:1},8,["code"]),d(c,{code:v(ue)},{default:w(()=>[d(ie)]),_:1},8,["code"])])]),_:1})}}});export{pe as default};
