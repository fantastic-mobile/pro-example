...
import{_ as D}from"./index--3D-Wt3r.js";import{_ as I}from"./index.vue_vue_type_script_setup_true_lang-AumOUN71.js";import{d as x,U as N,r as V,z,c as g,o as i,as as B,u as c,L as S,w as n,k as v,p as T,a as o,b as e,n as Y,F as M,bi as F,q as R,B as j,s as A,t as _,e as E}from"./index-U1W1hkh6.js";import{_ as L,a as q}from"./index.vue_vue_type_script_setup_true_lang-DCcrLzcQ.js";import{_ as y}from"./index.vue_vue_type_script_setup_true_lang-BsOXIoOk.js";import"./index.vue_vue_type_script_setup_true_lang-DppWa4d-.js";const G={key:0,class:"absolute top-0 z-1 w-20 flex-col-center-start p-2 backdrop-blur"},O={class:"flex items-center"},U={class:"w-full flex flex-col gap-4"},H={class:"flex items-center"},J={class:"flex-1"},K=x({name:"FmTimeline",__name:"index",props:{data:{default:()=>[]},merge:{type:Boolean,default:!1},class:{}},setup(p){const s=p,r=N("timelineItems"),a=V(0),m=z(()=>{const t=r.value?.map(h=>h.offsetTop-60);return Math.max(0,(t?.findIndex(h=>h>a.value)??1)-1)});function d(t){a.value=t.target.scrollTop}function l(t){return F(t).format("YYYY")}function P(t){return F(t).format("MM")}function w(t){return F(t).format("DD")}return(t,h)=>{const u=L,$=q,k=B;return i(),g(k,{"content-class":c(S)("relative w-full",s.class),onOnScroll:d},{default:n(()=>[t.data.length?(i(),v("div",G,[e(u,{value:Number(l(t.data[c(m)].datetime)),"will-change":"",format:{notation:"compact"},class:"text-lg font-bold opacity-20"},null,8,["value"]),o("div",O,[e($,null,{default:n(()=>[e(u,{value:Number(P(t.data[c(m)].datetime)),"will-change":"",format:{minimumIntegerDigits:2,notation:"compact"},suffix:"/",class:"text-xl font-bold"},null,8,["value"]),e(u,{value:Number(w(t.data[c(m)].datetime)),"will-change":"",format:{minimumIntegerDigits:2,notation:"compact"},class:"text-xl font-bold"},null,8,["value"])]),_:1})])])):T("",!0),o("div",U,[(i(!0),v(M,null,Y(t.data,(f,b)=>(i(),v("div",{key:b,ref_for:!0,ref_key:"timelineItems",ref:r,class:"flex gap-4"},[o("div",{class:R(["w-20 flex-col-center-start p-2 transition-all",{"opacity-0 -translate-y-10":b<=c(m),"opacity-0":s.merge&&b>0&&f.datetime===t.data[b-1].datetime}])},[e(u,{value:Number(l(f.datetime)),format:{notation:"compact"},class:"text-lg font-bold opacity-20"},null,8,["value"]),o("div",H,[e(u,{value:Number(P(f.datetime)),format:{minimumIntegerDigits:2,notation:"compact"},suffix:"/",class:"text-xl font-bold"},null,8,["value"]),e(u,{value:Number(w(f.datetime)),format:{minimumIntegerDigits:2,notation:"compact"},class:"text-xl font-bold"},null,8,["value"])])],2),o("div",J,[j(t.$slots,"default",{item:f},void 0,!0)])]))),128))])]),_:3},8,["content-class"])}}}),C=A(K,[["__scopeId","data-v-3d9835b1"]]),Q={key:0,class:"flex-center-end flex-1"},W=x({__name:"_demo1",setup(p){const s=[{datetime:"2025/03/23",content:"请假申请",name:"张三"},{datetime:"2025/03/23",content:"部门主管审批",name:"李四"},{datetime:"2025/03/24",content:"人事审批",name:"王五"},{datetime:"2025/03/24",content:"完成"}];return(r,a)=>{const m=y,d=C;return i(),g(d,{data:s},{default:n(({item:l})=>[e(m,{class:"h-full"},{header:n(()=>[o("div",null,_(l.content),1)]),footer:n(()=>[l.name?(i(),v("div",Q,[o("div",null,"操作人："+_(l.name),1)])):T("",!0)]),_:2},1024)]),_:1})}}}),X=`<script setup lang="ts">
const data = [
