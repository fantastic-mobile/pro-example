...
import{_ as h}from"./index-CmISDTFT.js";import{_ as g}from"./index.vue_vue_type_script_setup_true_lang-vDF_K-gu.js";import{_ as m,a as x}from"./index.vue_vue_type_script_setup_true_lang-CtATEes6.js";import{d as r,r as c,c as d,o as i,u as t,k as v,b as e,w as s,q as y,a as M}from"./index-CUJLi7no.js";import"./index.vue_vue_type_script_setup_true_lang-DvoaD5o-.js";const C=r({__name:"_demo1",setup(u){const n=c(0);return setInterval(()=>{n.value+=Math.floor(Math.random()*1e3)*(Math.random()>.5?1:-1)},2e3),(o,l)=>{const a=m;return i(),d(a,{value:t(n),"will-change":"",class:"text-4xl font-bold"},null,8,["value"])}}}),F=`<script setup lang="ts">
const value = ref(0)
