...
import{C as e,Ct as t,H as n,S as r,Tt as i,et as a,f as o,lt as s,mt as c,rt as l,v as u,w as d,x as f,y as p}from"./vue.runtime.esm-bundler-DMY3hWtO.js";import{C as m,P as h,R as g,S as _,r as v}from"./components-CBpXWGFQ.js";import{t as y}from"./AppPageLayout-S1V78StU.js";var b={class:`flex-start-center flex-wrap gap-2`},x=d({__name:`_demo1`,setup(d){let p=c(!1),h=c({closable:!0,center:!1,header:!0,footer:!0,contentHeight:``,loading:!1});a(()=>h.value.loading,e=>{e&&setTimeout(()=>{h.value.loading=!1},3e3)});function v(e,t){e===`close`?_().confirm({title:`提示`,content:`确定要关闭吗？`,onConfirm:()=>{t()}}):t()}return(a,c)=>{let d=g,_=m;return n(),f(o,null,[e(d,{onClick:c[0]||(c[0]=e=>p.value=!0)},{default:l(()=>[...c[8]||(c[8]=[r(` 打开 `,-1)])]),_:1}),e(_,{modelValue:t(p),"onUpdate:modelValue":c[7]||(c[7]=e=>s(p)?p.value=e:null),title:`标题`,description:`这里是一段描述介绍`,closable:t(h).closable,center:t(h).center,loading:t(h).loading,header:t(h).header,footer:t(h).footer,"before-close":v},{default:l(()=>[u(`div`,{class:i(t(h).contentHeight)},[u(`div`,b,[e(d,{variant:t(h).closable?`default`:`outline`,class:`w-full`,onClick:c[1]||(c[1]=e=>t(h).closable=!t(h).closable)},{default:l(()=>[...c[9]||(c[9]=[r(` 关闭按钮 `,-1)])]),_:1},8,[`variant`]),e(d,{variant:t(h).center?`default`:`outline`,class:`w-full`,onClick:c[2]||(c[2]=e=>t(h).center=!t(h).center)},{default:l(()=>[...c[10]||(c[10]=[r(` 居中显示 `,-1)])]),_:1},8,[`variant`]),e(d,{variant:t(h).header?`default`:`outline`,class:`w-full`,onClick:c[3]||(c[3]=e=>t(h).header=!t(h).header)},{default:l(()=>[...c[11]||(c[11]=[r(` 头部区域 `,-1)])]),_:1},8,[`variant`]),e(d,{variant:t(h).footer?`default`:`outline`,class:`w-full`,onClick:c[4]||(c[4]=e=>t(h).footer=!t(h).footer)},{default:l(()=>[...c[12]||(c[12]=[r(` 尾部区域 `,-1)])]),_:1},8,[`variant`]),e(d,{variant:t(h).contentHeight?`default`:`outline`,class:`w-full`,onClick:c[5]||(c[5]=e=>t(h).contentHeight=t(h).contentHeight?``:`h-400`)},{default:l(()=>[...c[13]||(c[13]=[r(` 切换内容高度 `,-1)])]),_:1},8,[`variant`]),e(d,{variant:`outline`,class:`w-full`,onClick:c[6]||(c[6]=e=>t(h).loading=!0)},{default:l(()=>[...c[14]||(c[14]=[r(` 显示加载中 `,-1)])]),_:1})])],2)]),_:1},8,[`modelValue`,`closable`,`center`,`loading`,`header`,`footer`])],64)}}}),S=`<script setup lang="ts">
...
`,C={class:`flex flex-wrap gap-4`},w=d({__name:`_demo2`,setup(t){function i(){_().info({title:`温馨提醒`,content:`这是 info 弹窗`,onConfirm:()=>{v.info(`你点了确定`)}})}function a(){_().success({title:`温馨提醒`,content:`这是 success 弹窗`,onConfirm:()=>{v.info(`你点了确定`)}})}function o(){_().warning({title:`温馨提醒`,content:`这是 warning 弹窗`,onConfirm:()=>{v.info(`你点了确定`)}})}function s(){_().error({title:`温馨提醒`,content:`这是 confirm 弹窗`,onConfirm:()=>{v.info(`你点了确定`)}})}function c(){_().confirm({title:`温馨提醒`,content:`这是 confirm 弹窗`,onConfirm:()=>{v.info(`你点了确定`)}})}function u(){let{update:e}=_().confirm({title:`温馨提醒`,content:`这是 confirm 弹窗`,beforeClose:(t,n)=>{t===`confirm`?e({title:`二次确认`,content:`确定要关闭吗？`,confirmButtonText:`我确定`,cancelButtonText:`我取消`,beforeClose:e=>{n()}}):n()}})}function d(){_().confirm({title:`温馨提醒`,content:`这是 confirm 弹窗`,confirmButtonText:`确认（随机成功或失败）`,beforeClose:async(e,t)=>{e===`confirm`?(await new Promise(e=>setTimeout(e,1e3)),Math.random()>.5?(v.success(`成功了！`),t()):v.error(`失败了！`)):t()}})}return(t,p)=>{let m=g;return n(),f(`div`,C,[e(m,{onClick:i},{default:l(()=>[...p[0]||(p[0]=[r(` Info `,-1)])]),_:1}),e(m,{onClick:a},{default:l(()=>[...p[1]||(p[1]=[r(` Success `,-1)])]),_:1}),e(m,{onClick:o},{default:l(()=>[...p[2]||(p[2]=[r(` Warning `,-1)])]),_:1}),e(m,{onClick:s},{default:l(()=>[...p[3]||(p[3]=[r(` Error `,-1)])]),_:1}),e(m,{onClick:c},{default:l(()=>[...p[4]||(p[4]=[r(` Confirm `,-1)])]),_:1}),e(m,{onClick:u},{default:l(()=>[...p[5]||(p[5]=[r(` Double Confirm `,-1)])]),_:1}),e(m,{onClick:d},{default:l(()=>[...p[6]||(p[6]=[r(` Confirm with promise `,-1)])]),_:1})])}}}),T=`<script setup lang="ts">
