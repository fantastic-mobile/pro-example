...
import{C as e,Ct as t,H as n,rt as r,v as i,w as a,x as o,y as s}from"./vue.runtime.esm-bundler-DOMO_wpA.js";import{et as c,p as l,x as u}from"./src-C_SUC8up.js";import{n as d}from"./dist-Bu4ITDzu.js";import{t as f}from"./AppPageLayout-CilNLEuS.js";var p={class:`p-2 bg-background flex flex-col h-50 w-full items-center justify-center relative overflow-hidden`},m=a({__name:`_demo1`,setup(r){let i=d();return(r,a)=>{let s=l;return n(),o(`div`,p,[e(s,{class:`inset-0 absolute`,color:t(i).currentColorScheme===`dark`?`#FFF`:`#000`},null,8,[`color`])])}}}),h=`<script setup lang="ts">
...
`,g={},_={class:`p-2 bg-background flex flex-col h-50 w-full items-center justify-center relative overflow-hidden`};function v(t,r){let i=l;return n(),o(`div`,_,[e(i,{class:`inset-0 absolute`,color:`#2563EB`,quantity:1e3,ease:100,staticity:5})])}var y=c(g,[[`render`,v]]),b=`<template>
  <div class="p-2 bg-background flex flex-col h-50 w-full items-center justify-center relative overflow-hidden">
    <FmParticlesBg
      class="inset-0 absolute"
      color="#2563EB"
...
`,w=a({__name:`index`,setup(a){return(a,o)=>{let c=u,l=f;return n(),s(l,{navbar:``,"navbar-start-side":`back`},{default:r(()=>[i(`div`,null,[e(c,{code:t(h)},{default:r(()=>[e(m)]),_:1},8,[`code`]),e(c,{code:t(b)},{default:r(()=>[e(y)]),_:1},8,[`code`]),e(c,{code:t(C)},{default:r(()=>[e(S)]),_:1},8,[`code`])])]),_:1})}}});export{w as default};