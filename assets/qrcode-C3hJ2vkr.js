...
`,z={class:`space-y-2`},B={class:`flex gap-4 items-center`},ee={class:`text-sm text-muted-foreground w-16`},V=m({__name:`_demo4`,setup(e){let a=d([200]),o=d(`https://fantastic-mobile.hurui.me`),c=s(()=>a.value[0]);return(e,s)=>{let l=C,d=S;return r(),h(`div`,z,[p(`div`,B,[t(l,{modelValue:n(a),"onUpdate:modelValue":s[0]||(s[0]=e=>u(a)?a.value=e:null),min:100,max:400,step:100,class:`w-48`},null,8,[`modelValue`]),p(`span`,ee,i(n(c))+`px`,1)]),t(d,{value:n(o),size:n(c)},null,8,[`value`,`size`])])}}}),H=`<script setup lang="ts">
...
`,Z={class:`flex flex-col gap-4`},Q={key:0,class:`text-success flex flex-col gap-1 items-center`},$={key:1,class:`text-muted-foreground flex flex-col gap-1 items-center`},te={key:2,class:`text-destructive flex flex-col gap-1 items-center`},ne=m({__name:`_demo6`,setup(e){let s=d(`loading`),u=d(`https://fantastic-mobile.hurui.me`),m=[{label:`加载中`,value:`loading`},{label:`已扫描`,value:`success`},{label:`已过期`,value:`expired`},{label:`错误`,value:`error`}];function g(e){s.value=e}return(e,d)=>{let y=_,b=v,C=x,w=S;return r(),h(`div`,Z,[t(b,null,{default:f(()=>[(r(),h(l,null,o(m,e=>t(y,{key:e.value,variant:n(s)===e.value?`default`:`outline`,onClick:t=>g(e.value)},{default:f(()=>[a(i(e.label),1)]),_:2},1032,[`variant`,`onClick`])),64))]),_:1}),t(w,{value:n(u),size:200,status:n(s)},{statusRender:f(({status:e})=>[e===`success`?(r(),h(`div`,Q,[t(C,{name:`i-mdi:check-circle`,class:`size-6`}),d[0]||(d[0]=p(`span`,{class:`text-xs`},`已扫描`,-1))])):e===`expired`?(r(),h(`div`,$,[t(C,{name:`i-mdi:clock-alert`,class:`size-6`}),d[1]||(d[1]=p(`span`,{class:`text-xs`},`二维码已过期`,-1))])):e===`error`?(r(),h(`div`,te,[t(C,{name:`i-mdi:alert-circle`,class:`size-6`}),d[2]||(d[2]=p(`span`,{class:`text-xs`},`加载失败`,-1))])):c(``,!0)]),_:1},8,[`value`,`status`])])}}}),re=`<script setup lang="ts">
