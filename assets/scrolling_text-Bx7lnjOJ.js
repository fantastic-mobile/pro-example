...
import{C as e,Ct as t,H as n,Tt as r,kt as i,rt as a,v as o,w as s,y as c}from"./vue.runtime.esm-bundler-DMY3hWtO.js";import{H as l,P as u,h as d,r as f}from"./components-CBpXWGFQ.js";import{t as p}from"./AppPageLayout-S1V78StU.js";var m={};function h(e,t){let r=d;return n(),c(r,{items:[`Fantastic-admin v6 正式发布，欢迎体验新特性！`,`框架已支持 Vue 3.6 + Vite 8，性能大幅提升`,`新增 30+ 内建 UI 组件，开箱即用`,`支持亮色/暗色主题，一键切换`],class:`text-sm flex-1 h-6`})}var g=l(m,[[`render`,h]]),_=`<template>
  <FmScrollingText
    :items="[
...
`,w={class:`py-1 flex gap-2 w-full items-center`},T={class:`text-sm truncate`},E=s({__name:`_demo4`,setup(e){let t=[{tag:`紧急`,text:`系统将于今晚 22:00 进行维护升级`,type:`error`},{tag:`新功能`,text:`支持批量导出数据，欢迎体验`,type:`success`},{tag:`提示`,text:`请及时更新您的账户安全信息`,type:`warning`}];return(e,s)=>{let l=d;return n(),c(l,{items:t.map(e=>e.text)},{item:a(({index:e})=>[o(`div`,w,[o(`span`,{class:r([`text-xs font-medium px-1.5 py-0.5 rounded shrink-0`,{"bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400":t[e].type===`error`,"bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400":t[e].type===`success`,"bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-400":t[e].type===`warning`}])},i(t[e].tag),3),o(`span`,T,i(t[e].text),1)])]),_:1},8,[`items`])}}}),D=`<script setup lang="ts">
const notices = [
