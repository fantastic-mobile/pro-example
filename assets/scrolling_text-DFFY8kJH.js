...
import{C as e,Ct as t,H as n,Ot as r,Tt as i,rt as a,v as o,w as s,y as c}from"./vue.runtime.esm-bundler-BBr2zMyZ.js";import{I as l,W as u,_ as d,r as f}from"./components-DK30L-iF.js";import{t as p}from"./AppPageLayout-BwSv5Viu.js";var m={};function h(e,t){let r=d;return n(),c(r,{items:[`Fantastic-admin v6 正式发布，欢迎体验新特性！`,`框架已支持 Vue 3.6 + Vite 8，性能大幅提升`,`新增 30+ 内建 UI 组件，开箱即用`,`支持亮色/暗色主题，一键切换`],class:`text-sm flex-1 h-6`})}var g=u(m,[[`render`,h]]),_=`<template>
  <FmScrollingText
    :items="[
...
`,O=s({__name:`index`,setup(r){return(r,i)=>{let s=l,u=p;return n(),c(u,{navbar:``,"navbar-start-side":`back`},{default:a(()=>[o(`div`,null,[e(s,{code:t(_)},{default:a(()=>[e(g)]),_:1},8,[`code`]),e(s,{title:`多条可见 + fade 动画`,code:t(x)},{default:a(()=>[e(b)]),_:1},8,[`code`]),e(s,{title:`向下滚动 + 点击事件`,code:t(C)},{default:a(()=>[e(S)]),_:1},8,[`code`]),e(s,{title:`自定义条目 slot`,code:t(D)},{default:a(()=>[e(E)]),_:1},8,[`code`])])]),_:1})}}});export{O as default};