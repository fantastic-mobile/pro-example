...
`,m=s({__name:`index`,setup(r){return(r,i)=>{let o=u,s=d;return n(),c(s,{navbar:``,"navbar-start-side":`back`},{default:a(()=>[e(o,{code:t(p)},{default:a(()=>[e(f)]),_:1},8,[`code`])]),_:1})}}});export{m as default};