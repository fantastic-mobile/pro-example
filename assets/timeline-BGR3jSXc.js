...
import{C as e,Ct as t,H as n,Ot as r,S as i,b as a,rt as o,v as s,w as c,x as l,y as u}from"./vue.runtime.esm-bundler-BBr2zMyZ.js";import{I as d,a as f,z as p}from"./components-DK30L-iF.js";import{t as m}from"./AppPageLayout-BwSv5Viu.js";var h={key:0,class:`flex-center-end flex-1`},g=c({__name:`_demo1`,setup(t){let i=[{datetime:`2025/03/23`,content:`请假申请`,name:`张三`},{datetime:`2025/03/23`,content:`部门主管审批`,name:`李四`},{datetime:`2025/03/24`,content:`人事审批`,name:`王五`},{datetime:`2025/03/24`,content:`完成`}];return(t,c)=>{let d=p,m=f;return n(),u(m,{data:i},{default:o(({item:t})=>[e(d,{class:`h-full`},{header:o(()=>[s(`div`,null,r(t.content),1)]),footer:o(()=>[t.name?(n(),l(`div`,h,[s(`div`,null,`操作人：`+r(t.name),1)])):a(``,!0)]),_:2},1024)]),_:1})}}}),_=`<script setup lang="ts">
const data = [
...
`,v={key:0,class:`flex-center-end flex-1`},y=c({__name:`_demo2`,setup(t){let i=[{datetime:`2025/03/23`,content:`请假申请`,name:`张三`},{datetime:`2025/03/23`,content:`部门主管审批`,name:`李四`},{datetime:`2025/03/24`,content:`人事审批`,name:`王五`},{datetime:`2025/03/24`,content:`完成`}];return(t,c)=>{let d=p,m=f;return n(),u(m,{data:i,merge:``},{default:o(({item:t})=>[e(d,{class:`h-full`},{header:o(()=>[s(`div`,null,r(t.content),1)]),footer:o(()=>[t.name?(n(),l(`div`,v,[s(`div`,null,`操作人：`+r(t.name),1)])):a(``,!0)]),_:2},1024)]),_:1})}}}),b=`<script setup lang="ts">
const data = [
  { datetime: '2025/03/23', content: '请假申请', name: '张三' },
  { datetime: '2025/03/23', content: '部门主管审批', name: '李四' },
  { datetime: '2025/03/24', content: '人事审批', name: '王五' },
...
`,C=c({__name:`index`,setup(r){return(r,i)=>{let a=d,c=m;return n(),u(c,{navbar:``,"navbar-start-side":`back`},{default:o(()=>[s(`div`,null,[e(a,{code:t(_)},{default:o(()=>[e(g)]),_:1},8,[`code`]),e(a,{code:t(b),title:`合并时间线`},{default:o(()=>[e(y)]),_:1},8,[`code`]),e(a,{code:t(S),title:`设置高度并出现滚动条`},{default:o(()=>[e(x)]),_:1},8,[`code`])])]),_:1})}}});export{C as default};