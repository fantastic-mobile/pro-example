...
import{_ as b}from"./index-DDuBEHMP.js";import{d as g,ad as w,bl as S,z as v,c as x,o as V,w as a,a as W,b as s,a3 as u,af as B,i as C,u as n,_ as Y,e as c,a4 as i,b6 as D}from"./index-DfiWcGfx.js";const F={class:"flex flex-col items-center gap-4 p-4"},H=g({__name:"watermark",setup(N){const o=w(),r=S(),t=v({get(){return o.settings.app.enableWatermark},set(m){o.$patch(e=>{e.settings.app.enableWatermark=m})}});function p(){r.update({content:D().format(`YYYY-MM-DD
