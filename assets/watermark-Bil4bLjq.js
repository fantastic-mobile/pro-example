...
import{_ as b}from"./index-d6ZB0Jya.js";import{d as g,ag as w,bl as S,z as v,c as x,o as V,w as a,a as W,b as s,a5 as l,ai as B,i as C,u as n,_ as Y,e as u,a6 as _,bi as D}from"./index-BLP5v8hh.js";const F={class:"flex flex-col items-center gap-4 p-4"},H=g({__name:"watermark",setup(N){const o=w(),r=S(),t=v({get(){return o.settings.app.enableWatermark},set(m){o.$patch(e=>{e.settings.app.enableWatermark=m})}});function c(){r.update({content:D().format(`YYYY-MM-DD
