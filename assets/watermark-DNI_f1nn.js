...
import{C as e,Ct as t,H as n,Pt as r,S as i,_ as a,c as o,it as s,lt as c,rt as l,v as u,w as d,y as f}from"./vue.runtime.esm-bundler-DMY3hWtO.js";import{R as p,c as m,tt as h}from"./components-CBpXWGFQ.js";import{n as g}from"./dist-SpGahdYJ.js";import{t as _}from"./index-CyGzgZKn.js";import{t as v}from"./AppPageLayout-S1V78StU.js";var y=r(h(),1),b={class:`p-4 flex flex-col gap-4 items-center`},x=d({__name:`watermark`,setup(r){let d=g(),h=_(),x=a({get(){return d.settings.app.watermark},set(e){d.$patch(t=>{t.settings.app.watermark=e})}});function S(){h.update({content:(0,y.default)().format(`YYYY-MM-DD
