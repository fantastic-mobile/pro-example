...
import{_ as b}from"./index-_igKEK-M.js";import{d as g,Y as w,a4 as V,O as W,c as x,w as a,m as l,o as S,a as C,b as n,u as s,i as Y,V as p,W as c,e as i,Q as B}from"./index-BWEzkdYe.js";const D={class:"flex flex-col items-center gap-4 p-4"},H=g({__name:"watermark",setup(N){const o=w(),r=V(),t=W({get(){return o.settings.app.enableWatermark},set(m){o.$patch(e=>{e.settings.app.enableWatermark=m})}});function d(){r.update({content:B().format(`YYYY-MM-DD
