...
import{_ as b}from"./index-C0aM3m2R.js";import{d as g,ah as w,bm as S,z as v,c as x,o as V,w as a,a as W,b as s,a6 as l,aj as B,i as C,u as n,_ as Y,e as _,a7 as c,bj as j}from"./index-D1JO3_V0.js";const D={class:"flex flex-col items-center gap-4 p-4"},h=g({__name:"watermark",setup(F){const o=w(),r=S(),t=v({get(){return o.settings.app.enableWatermark},set(m){o.$patch(e=>{e.settings.app.enableWatermark=m})}});function i(){r.update({content:j().format(`YYYY-MM-DD
